...
const LESSONS: Lesson[] = [
  ...
  { id: 5, titleJa: '喜怒哀楽〜感情表現を知ろう', titleAr: 'تعلم التعبير عن المشاعر', descJa: '喜び・怒り・哀しみ・楽しみの4つの感情表現を描き分ける方法。', descAr: 'تعلم رسم أربعة تعبيرات عاطفية: الفرح والغضب والحزن والسعادة.', category: '表現技法', duration: '20分', pages: 'P20-23', videoJa: '7zfUsllB7Lo', videoAr: '7oYAunpuq9Y', icon: '😊' },
  { id: 6, titleJa: '効果線の活用', titleAr: 'استخدام خطوط التأثير', descJa: '流線、カケアミ、集中線など、マンガの表現力を高める効果線の描き方。（動画準備中）', descAr: 'تعلم رسم خطوط التأثير. (الفيديو قيد الإعداد)', category: '表現技法', duration: '15分', pages: 'P24-25', videoJa: '', videoAr: '', icon: '💫' },
  { id: 7, titleJa: '描き文字を使おう', titleAr: 'استخدام المؤثرات الصوتية', descJa: 'バン！ドン！など、描き文字（オノマトペ）の使い方。（動画準備中）', descAr: 'تعلم استخدام المؤثرات الصوتية المرسومة. (الفيديو قيد الإعداد)', category: '表現技法', duration: '15分', pages: 'P26-27', videoJa: '', videoAr: '', icon: '💥' },
  { id: 8, titleJa: '背景を描こう', titleAr: 'لنرسم الخلفيات', descJa: 'アイレベル、消失点、一点透視図法など、パースの基本を学びます。', descAr: 'تعلم أساسيات المنظور مثل مستوى العين ونقطة التلاشي.', category: '背景・構図', duration: '30分', pages: 'P28-35', videoJa: 'dS6qdOL7QMo', videoAr: 'Rr2rlAGX0UQ', icon: '🏙️' },
  { id: 9, titleJa: '起承転結って何？コマ割りを知ろう', titleAr: 'ما هي البنية الدرامية؟ تعلم تقسيم اللوحات', descJa: 'ストーリーの基本構造とコマ割りのテクニック。', descAr: 'تعلم البنية الأساسية للقصة وتقنيات تقسيم اللوحات.', category: 'ストーリー', duration: '30分', pages: 'P36-43', videoJa: 'qGroRIqDCSA', videoAr: 'CtuyK2yF4XE', icon: '📐' },
  { id: 10, titleJa: '4コマ漫画を描いてみよう', titleAr: 'لنرسم مانجا من 4 لوحات', descJa: '起承転結を4コマで表現し、オリジナル4コマ漫画を描きます。', descAr: 'تعلم التعبير عن البنية الدرامية في 4 لوحات.', category: 'ストーリー', duration: '25分', pages: 'P44-47', videoJa: '_Jm9hf8y2BM', videoAr: 'y6yebS0WXZw', icon: '📝' },
  { id: 11, titleJa: 'キャラクターが動く仕組み・パラパラ漫画', titleAr: 'آلية حركة الشخصيات - رسوم متحركة بالورق', descJa: 'アニメーションの基本原理を学び、パラパラ漫画を作ります。', descAr: 'تعلم المبادئ الأساسية للرسوم المتحركة واصنع كتاب قلب.', category: 'アニメーション', duration: '25分', pages: 'P48-53', videoJa: 'a2Pk92FbYVY', videoAr: '1AOKDO_5dTk', icon: '🎬' },
  { id: 12, titleJa: 'CLIP STUDIO DEBUTの楽しみ方', titleAr: 'كيفية الاستمتاع بـ CLIP STUDIO DEBUT', descJa: 'デジタル作画ソフトの基本ツールの使い方を学びます。（動画準備中）', descAr: 'تعلم استخدام الأدوات الأساسية لبرنامج الرسم الرقمي. (الفيديو قيد الإعداد)', category: 'デジタル', duration: '30分', pages: 'P60-65', videoJa: '', videoAr: '', icon: '🖥️' },
];
...
<div className="aspect-video rounded-2xl overflow-hidden mb-8 bg-black">
          ...
          <div className="flex gap-4">
            ...
            {selected.id < 9 && (
              <button onClick={() => setSelected(LESSONS[selected.id])} className="bg-slate-800 hover:bg-slate-700 px-6 py-3 rounded-xl font-bold transition">
...
<p className="text-gray-400 mt-2">{lang === 'ar' ? '١٢ درس' : '全12レッスン'}</p>
        </div>
      </div>
