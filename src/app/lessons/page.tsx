...
const LESSONS: Lesson[] = [
  ...
  { id: 7, titleJa: '効果線の活用', titleAr: 'استخدام خطوط التأثير', descJa: '流線、カケアミ、集中線など、マンガの表現力を高める効果線の描き方。', descAr: 'تعلم رسم خطوط التأثير مثل خطوط السرعة والتظليل المتقاطع.', category: '表現技法', duration: '15分', pages: 'P24-25', videoJa: 'cCCda4FKI78', videoAr: '8zvzNxbMbYA', icon: '💫' },
  { id: 8, titleJa: '描き文字を使おう', titleAr: 'استخدام المؤثرات الصوتية', descJa: 'バン！ドン！など、描き文字（オノマトペ）の使い方。', descAr: 'تعلم استخدام المؤثرات الصوتية المرسومة.', category: '表現技法', duration: '15分', pages: 'P26-27', videoJa: 'cCCda4FKI78', videoAr: '8zvzNxbMbYA', icon: '💥' },
  ...
  { id: 11, titleJa: '起承転結って何？コマ割りを知ろう（講座）', titleAr: 'البنية الدرامية وتقسيم اللوحات (محاضرة)', descJa: '浜田ブリトニー先生による起承転結・コマ割り講座。', descAr: 'محاضرة البنية الدرامية وتقسيم اللوحات مع المعلمة.', category: 'ストーリー', duration: '30分', pages: 'P36-43', videoJa: 'NvaIP7T15qQ', videoAr: 'fSJTKUGFEZ8', icon: '🎓' },
  ...
  { id: 13, titleJa: '4コマ漫画を描いてみよう（講座）', titleAr: 'لنرسم مانجا من 4 لوحات (محاضرة)', descJa: '浜田ブリトニー先生による4コマ漫画の講座。', descAr: 'محاضرة مانجا من 4 لوحات مع المعلمة.', category: 'ストーリー', duration: '25分', pages: 'P44-47', videoJa: 'NvaIP7T15qQ', videoAr: 'fSJTKUGFEZ8', icon: '🎓' },
